...
public class MainScreen extends javax.swing.JFrame implements WritableGUI {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("R Port");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("T port");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(targetPort, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void listenButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listenButtonActionPerformed
        ...
        if(targetPort.getText().equals("T port") || receivePort.getText().equals("R Port") || key.getText().equals("En Key") || 
                targetPort.getText().equals("") || receivePort.getText().equals("") || key.getText().equals("") 
                || user.getText().equals("") ){
            
            WritableGUI gui = this;
            gui.write("You did not correctly inserted En Key or R port or T port or Name. You are requested to verify these please");
